...
{
    header("location:../loginAndRegister/home.php");
}
...
if(isset($_POST["login"]))
{
    $un=$_POST["userId"];
    $pwd=$_POST["password"];
    $s="select * from admin where userid='".$un."'";
    ...
    if($row["password"]==$pwd)
    {
        ...
        $_SESSION["adminpic"]=$row['pic'];
        header("location:home/home.php");
    }
    else{
        echo "<script>alert('Please put correct infomation!')</script>";
    }
}
